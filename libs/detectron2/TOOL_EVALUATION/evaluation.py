...
if __name__ == '__main__':
    ...
    python ./TOOL_EVALUATION/evaluation.py \
            "/storageStudents/Datasets/ICDAR2021_MDF/test" \
            "/storageStudents/K2018/tiendv/tiennv/mfd_2021/detectron2/TOOL_EVALUATION/_5_Ts00+01.csv" \
            --output
    
    python ./TOOL_EVALUATION/evaluation.py \
            "/storageStudents/Datasets/ICDAR2021_MDF/test" \
            "/storageStudents/K2018/tiendv/tiennv/mfd_2021/detectron2/TOOL_EVALUATION/combine_faster_and_yolo_Tr10.csv" \
            --output
        python ./TOOL_EVALUATION/evaluation.py \
            "/mlcv/Databases/mfd2021/Va00+Va01/" \
            "/mlcv/WorkingSpace/NCKH/tiennv/mfd_2021/detectron2/TOOL_EVALUATION/model_cfg2submission.csv" \
    
    python ./TOOL_EVALUATION/evaluation.py \
            "/mlcv/Databases/mfd2021/Va00+Va01/" \
            "/mlcv/WorkingSpace/NCKH/tiennv/mfd_2021/detectron2/TOOL_EVALUATION/model_cfg3submission.csv" 
    '''
