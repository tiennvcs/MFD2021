"""
Usage:
    python test.py --img-size 768 \
        --task test --data data/mfd_2class_all.yaml \
        --conf-thres 0.4 --iou-thres 0.6 \
        --device 0 --verbose --name testing_yolov5m \
        --batch-size 1 --weights runs/train/yolov5m_all/weights/best.pt
"""
